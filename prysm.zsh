...
devnet() {
    kurtosis clean -a &&
        docker build --file ~/.zsh/containers/prysm/Dockerfile.bn . -t prysm-bn-custom-image &&
        docker build --file ~/.zsh/containers/prysm/Dockerfile.vc . -t prysm-vc-custom-image &&
